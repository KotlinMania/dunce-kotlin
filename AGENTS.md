...
This file is the quick-reference operating contract for dunce-kotlin. The longer
...
dunce-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`dunce`](https://crates.io/crates/dunce). Upstream Rust is the behavioral oracle while the
