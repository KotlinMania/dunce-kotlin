...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Dunce.swiftmodule/`
...
//      `import Dunce` above would fail at compile time.
//
//   2. The static archive `libDunce.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Dunce" }` and
//      `flattenPackage = "io.github.kotlinmania.dunce"` configuration in
...
final class DunceExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Dunce swift module imported cleanly")
    }
}
